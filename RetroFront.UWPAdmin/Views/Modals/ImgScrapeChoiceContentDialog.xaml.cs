...
{
    public sealed partial class ImgScrapeChoiceContentDialog : ContentDialog
    {
        public ImgScrapeChoiceViewModel ViewModel { get; } = new ImgScrapeChoiceViewModel();
        public ImgScrapeChoiceContentDialog(ImgScrapeChoiceViewModel vm)
        {
            ViewModel = vm;
