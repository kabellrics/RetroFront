...
{
    public sealed partial class ScrapeResolverContentDialog : ContentDialog
    {
        public ScrapeResolverViewModel ViewModel { get; } = new ScrapeResolverViewModel();
        public ScrapeResolverContentDialog(ScrapeResolverViewModel viewModel)
        {
