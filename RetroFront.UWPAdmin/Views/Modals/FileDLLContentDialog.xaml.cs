...
{
    public sealed partial class FileDLLContentDialog : ContentDialog
    {
        public FileModalDLLViewModel ViewModel { get; set; }
        public FileDLLContentDialog(FileModalDLLViewModel vm)
        {
            try
            {
                    ViewModel = vm;
