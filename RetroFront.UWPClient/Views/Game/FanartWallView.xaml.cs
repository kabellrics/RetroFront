...
{
    public sealed partial class FanartWallView : UserControl
    {
        public JeuxViewModel ViewModel => (JeuxViewModel)DataContext;
        public FanartWallView()
        {
        ...
        private void GridView_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            try
            {
                ...
                ((ItemsWrapGrid)grid.ItemsPanelRoot).ItemWidth = e.NewSize.Width / 3.2;
                ((ItemsWrapGrid)grid.ItemsPanelRoot).ItemHeight = e.NewSize.Height / 3.2;
            }
            catch (Exception ex)
            {
                //throw;
