...
namespace RetroFront.UWPAdmin.Core.Models
{
    public class DisplaySysteme: DisplayBase
    {
        ...
        public string ShortName
        {
            ...
            set => SetProperty(Systeme.Shortname, value, Systeme,(syteme,item) => Systeme.Shortname = item);
        }
        public int ScreenScraperID
        {
            get => Systeme.SystemeSCSPID;
            set => SetProperty(Systeme.SystemeSCSPID, value, Systeme,(syteme,item) => Systeme.SystemeSCSPID = item);
        }
        public SysType Type
        {
            get => Systeme.Type;
